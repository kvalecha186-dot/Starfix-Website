/* ─────────────────────────────────────────────────────────────────────────
   Full ISO 3166-1 country + territory list (name + alpha-2 code). The
   alpha-2 code is all CountrySelect needs — flag emoji are derived from it
   at render time via Unicode regional-indicator symbols, so there's no
   separate flag asset list to keep in sync.
───────────────────────────────────────────────────────────────────────── */
...
/** Derives a flag emoji from an ISO alpha-2 code via Unicode regional-indicator symbols. */
